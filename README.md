...
1. Explain what a token is used for.
    They are cryptic strings of text stored using local or session storage, that can be read by a server to help make transfer decisions based on the clients permission.

2. What steps can you take in your web apps to keep your data secure?
    You can use private routes that require a token, and in some cases particular roles, in order to access the content.

3. Describe how web servers work.
    They are computers connected to the internet that store code for different websites to be shared at all times. Thus they are hosting the websites.

4. Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.
    We use PUT, POST, GET, PUT with an existing URL, and DELETE.